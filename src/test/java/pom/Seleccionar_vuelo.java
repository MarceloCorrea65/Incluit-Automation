...
public class Seleccionar_vuelo extends Base{
    ...
    private By boton_choose_this_flight = new By.ByXPath("//tr[1]/td[1]/input[@type='submit']");
    private By titulo_page_select_vuelo = new By.ByXPath("//h3[contains(text(),'Flights from')]");
